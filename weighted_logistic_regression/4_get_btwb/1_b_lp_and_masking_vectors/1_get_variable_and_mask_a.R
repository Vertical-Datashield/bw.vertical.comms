...
bmv2_betab_out="/home/rw13742/Documents/datashield/testing/vertical_comms/data/test.data/simulated_self_harm_data/b/bmv2_betab.csv"
...
bmv2_out="/home/rw13742/Documents/datashield/testing/vertical_comms/data/test.data/simulated_self_harm_data/b/bmv2.csv"
...
bmv2_betab<-rep(NA, ncol(b))
for (i in 1:nrow(b)){
bmv2_betab[i]<-mask[i] + (betas[1] * b[i]) #bmv2 + beta1*x1
}

write.table(bmv2_betaa, row.names=FALSE, sep=",", file = bmv2_betab_out)
